...
The collision duration is the time it takes for a collision to occur. This is important because if the simulation timestep is not low enough there won't be enough steps within a collision to produce accurate results. The collision duration is fully derived in Appendix \ref{ch:Derivations} (section \ref{der:collision duration} and is calculated using equation \ref{eq:collision duration}.
\begin{equation}
