...
\end{figure}
\section{Kernels}
The main calculations for this implementation are performed on the device. This means that the program must be separated into kernels to be passed over a set of data.
\subsection{Collision Detection}
\subsection{Collision Resolution}
