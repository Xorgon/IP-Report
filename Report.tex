...
\section{Overview}
An initial implementation of the Discrete Element Method has been done in Python. The objective of which is to gain an understanding of the DEM and any computational difficulties. Python has been chosen for its simplicity and ease of implementation for a testing environment.
